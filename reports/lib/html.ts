...
@media (max-width:720px){
  .hide-m{display:none!important}.tbl{overflow-x:auto}table{font-size:13px}td,th{padding:8px 10px}.tbl tbody tr:hover td{background:none}
  .stack table,.stack tbody,.stack tr,.stack td,.collapse table,.collapse tbody,.collapse tr,.collapse td{display:block}.stack thead,.collapse thead{display:none}
  .stack tr,.collapse tr{padding:10px 12px;border-bottom:1px solid var(--line)}.stack tr:last-child,.collapse tr:last-child{border-bottom:0}
  .stack td,.collapse td{padding:2px 0;border:0;text-align:left!important}.stack td:empty,.collapse td:empty{display:none}
  .stack td[data-l]::before,.collapse td[data-l]::before{content:attr(data-l);display:inline-block;min-width:88px;font-family:var(--display);font-weight:700;font-size:10.5px;letter-spacing:.12em;text-transform:uppercase;color:var(--muted);margin-right:8px}
  .stack td.name,.collapse td.name{font-size:15.5px;padding-bottom:2px}.stack td.name::before,.collapse td.name::before{display:none}.stack td.amt,.collapse td.amt{font-size:17px;font-weight:700;padding-bottom:2px}.stack td.amt::before,.collapse td.amt::before{display:none}
  .collapse td.name{padding-right:28px}.collapse td.brief{display:block;font-size:12.5px;color:var(--muted);padding-bottom:2px}.collapse tr{position:relative;cursor:pointer}.collapse tr::after{content:"";position:absolute;right:14px;top:16px;width:8px;height:8px;border-right:2px solid var(--muted);border-bottom:2px solid var(--muted);transform:rotate(45deg);transition:transform .15s}.collapse tr.open::after{transform:rotate(-135deg);top:20px}
  .collapse tr:not(.open) td:not(.name):not(.amt):not(.brief){display:none}.collapse tr.open td[data-l]{padding-top:4px}
}
...
@media print{
  ...
  .tbl{border:0}table{font-size:10.5px}td,th{padding:4px 6px}tr{break-inside:avoid}td.brief{display:none!important}.collapse tr::after{display:none}.collapse tr:not(.open) td{display:table-cell}
...
<main><section class="sec"><div class="wrap">
  ...
  ${table("donor-table", `<th data-k="name">Donor</th><th data-k="total" class="r">Total</th><th data-k="count" class="r">Gifts</th><th data-k="pledged" class="r">Pledged</th><th data-k="paid" class="r">Online</th><th data-k="first">First gift</th><th>Context</th>${r.bloomerang.connected ? "<th>History</th>" : ""}`, "collapse")}
...
<main><section class="sec"><div class="wrap">
  ...
  ${table("gift-table", `<th data-k="t">Time</th><th data-k="donor">Donor</th><th data-k="amount" class="r">Amount</th><th data-k="method">Method</th><th data-k="source">Source</th><th data-k="by">Recorded by</th><th data-k="collection">Payment</th><th>Note</th>`, "collapse")}
</div></section></main>${foot}`);
