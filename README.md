...
| **Main Ballroom Screen** | `/stage` | 1080p Projector / LED Wall | 130px rolling odometer, concentric progress line, matching grant banner, adaptive QR code, and lower-third chyron ticker. |
| **Event Control Room** | `/control` | AV Tech / Director Laptop | 3-tab operational deck: 8-second staging queue with 1-click hold button, audited ledger list, live settings & QR customizer, and tech rehearsal simulator. |
...
1. **Tech Rehearsal**: Open `/control`, switch to Tab 3 (Setup & Rehearsal), click **"Test 7-Pledge Burst"**, and verify the 1080p `/stage` odometer rolls forward smoothly at 60 FPS.
